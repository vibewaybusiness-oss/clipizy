...
class UserCreationService:
    ...
    def create_user_complete(self, db: Session, user_data: UserCreate, oauth_provider: Optional[str] = None) -> User:
        """
        ...
        try:
            ...
            user = self._create_database_user(db, user_data, oauth_provider)
            if not user:
    ...
    def _create_database_user(self, db: Session, user_data: UserCreate, oauth_provider: Optional[str] = None) -> Optional[User]:

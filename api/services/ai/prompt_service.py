...
PROMPTS_PATH = Path(__file__).resolve().parent.parent.parent / "config" / "prompts_random.json"
PROMPT_RULES_PATH = Path(__file__).resolve().parent.parent.parent / "config" / "prompt_rules.json"

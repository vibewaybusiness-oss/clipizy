...
class AdvancedTransitionService:
    ...
    def __init__(self):
        self.temp_dir = Path(tempfile.gettempdir()) / "vibewave_transitions"
...
class ChromaKeyService:
    ...
    def __init__(self):
        self.temp_dir = Path(tempfile.gettempdir()) / "vibewave_chroma"
        self.temp_dir.mkdir(exist_ok=True)
...
class VideoEffectsService:
    ...
    def __init__(self):
        self.temp_dir = Path(tempfile.gettempdir()) / "vibewave_effects"
        self.temp_dir.mkdir(exist_ok=True)
...
class VideoHelperService:
    ...
    def __init__(self, storage, json_store: JSONStore):
        ...
        self.temp_dir = Path(tempfile.gettempdir()) / "vibewave_helper"
        self.temp_dir.mkdir(exist_ok=True)

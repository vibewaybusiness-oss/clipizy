#!/usr/bin/env python3
"""
Simple script to set up a new SQLite database with all required tables
"""
import os
import sys
import uuid
...
os.environ["DATABASE_URL"] = "sqlite:///./vibewave_new.db"
...
def setup_new_database():
    """Set up a new SQLite database with all required tables"""
    
    # Set up SQLite database URL
    db_path = os.path.join(os.path.dirname(__file__), "..", "vibewave_new.db")

...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Vibewave AI-powered music video creation platform',
  robots: {
    index: true,
    follow: true,
  },
          ...
          <div className="space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>Videos and other content generated through Vibewave</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  You can manage many preferences directly through your account settings. For other requests, contact us at privacy@vibewave.ai. We respond within 30 days.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Vibewave provides automated tools for generating multimedia content. We do not monitor or review user input or AI-generated outputs before delivery. You are solely responsible for the legality, accuracy, and appropriateness of any content created, uploaded, or distributed using Vibewave.
                </p>
                <p>
                  Vibewave disclaims all liability arising from user-generated or AI-generated content, including but not limited to intellectual property infringement, offensive or unlawful material, and misuse of the Service.
                </p>
              </CardContent>
            </Card>

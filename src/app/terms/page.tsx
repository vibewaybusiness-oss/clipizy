...
export const metadata: Metadata = {
  title: 'Terms of Service - clipizi',
  description: 'Terms of Service for clipizi AI-powered music video creation platform',
  robots: {
    index: true,
    follow: true,
  },
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              clipizi Terms of <span className="gradient-text">Service</span>
            </h1>
          ...
          <div className="space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  These Terms of Service ("Terms") govern your access to and use of clipizi ("the Service"), an AI-powered multimedia creation platform. By using the Service, you agree to these Terms. If you do not agree, you must discontinue use immediately.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  clipizi provides AI-powered tools that allow users to generate, edit, and distribute multimedia content. Core features include:
                </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>Immediately notifying clipizi of any unauthorized access</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  You retain full ownership of all content you upload to clipizi, including audio, video, images, and other media. By submitting content, you grant clipizi a limited, non-exclusive license to store, process, and use such content solely for the purpose of operating and improving the Service.
                </p>

                <h3 className="font-semibold text-lg">4.2 AI-Generated Content</h3>
                <p>
                  Content generated by clipizi's AI tools using your input materials belongs to you. You may use such generated content for commercial or non-commercial purposes in accordance with your subscription plan. clipizi does not claim copyright ownership of user-generated outputs.
                </p>
                <p>
                  By using the Service, you grant clipizi a limited license to store and process generated content for service delivery, and (with your consent) to showcase examples for marketing or research purposes.
                </p>

                <h3 className="font-semibold text-lg">4.3 clipizi Platform</h3>
                <p>
                  All rights, title, and interest in and to clipizi's software, algorithms, models, media libraries, templates, trademarks, and related technology remain the exclusive property of clipizi. Your use of the Service does not transfer any ownership rights.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Your privacy is important to us. Our practices for collecting, using, and protecting your personal data are outlined in our Privacy Policy. While clipizi uses industry-standard security practices, you acknowledge that no system is completely secure and use the Service at your own risk.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  clipizi may suspend or terminate your account immediately if you violate these Terms or engage in harmful conduct. Upon termination, your right to use the Service ends immediately, and clipizi may delete your data. Where feasible, we will provide reasonable notice.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  clipizi reserves the right to update or modify these Terms at any time. Material changes will be communicated via email or within the Service. Continued use of clipizi after changes constitutes acceptance.
                </p>
              </CardContent>
            </Card>

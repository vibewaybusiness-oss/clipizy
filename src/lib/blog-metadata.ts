...
export function generateBlogPostMetadata(post: BlogPostMetadata): Metadata {
  return {
    ...
    openGraph: {
      ...
      authors: [post.author],
      tags: post.tags,
      url: `https://vibewave.ai/blog/${post.slug}`,
      siteName: 'Vibewave',
      images: [
        {
          url: `https://vibewave.ai/blog/${post.slug}.jpg`,
          width: 1200,
          height: 630,
          alt: post.title,
        },
    ...
    twitter: {
      ...
      title: post.title,
      description: post.description,
      images: [`https://vibewave.ai/blog/${post.slug}.jpg`],
    },
    alternates: {
      canonical: `https://vibewave.ai/blog/${post.slug}`,
    },
  };
}
...
export const blogPostMetadata: Record<string, BlogPostMetadata> = {
  'ai-music-video-generator-5-minutes': {
    title: 'Make a Music Video in 5 Minutes with AI | Vibewave',
  ...
  'top-ai-music-video-generators-2025': {
    ...
    description: 'Discover the best AI music video makers in 2025. Compare Vibewave, Pictory, InVideo, Runway, and Descript to find your perfect fit.',

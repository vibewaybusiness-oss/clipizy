...
class RunPodGraphQLClient {
  ...
  private loadApiKey(): string {
    ...
    const keyPath = path.resolve(process.cwd(), 'api', 'runpod_api_privatekey');
    ...
    throw new Error('RunPod API key not found. Please set RUNPOD_API_KEY environment variable or create a file with your API key in api directory.');
  }
...
export class RunPodRestClient {
  ...
  private loadApiKey(): string {
    ...
    throw new Error('RunPod API key not found. Set RUNPOD_API_KEY environment variable or create api/runpod_api_privatekey file');
  }

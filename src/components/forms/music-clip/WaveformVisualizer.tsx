...
import { Scene } from '@/components/forms/music-clip/ClipiziGenerator';
import { WaveformVisualizerRef, WaveformVisualizerProps } from '@/types/components/waveform.types';
import { useWaveformVisualizer } from '@/hooks/music-clip/useWaveformVisualizer';
import { formatTime } from '@/utils/components/waveform.utils';

    ...
    <Form {...form}>
      ...
      >
        <div className="h-full flex flex-col">
                    ...
                    {musicTracks.map((track) => (
                      ...
                      >
                        <div className="flex flex-col items-center space-y-2">
                          ...
                          {selectedTrackId === track.id && (
                            <Badge variant="secondary" className="px-2 py-1 text-xs">Selected</Badge>
                          )}
                        </div>
                      </div>
                    ))}
          ...
          {/* AUDIO ANALYSIS VISUALIZER - FULL WIDTH BELOW COLUMNS */}

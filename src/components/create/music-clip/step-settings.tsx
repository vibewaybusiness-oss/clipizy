...
export function StepSettings({ form, audioDuration, totalDuration, trackCount, trackDurations, onSubmit, onBack, hideNavigation = false }: StepSettingsProps) {
  ...
  // Simplified pricing - use fixed values
  const loopedVideoCost = 100; // Fixed cost for looped videos
  const scenesVideoCost = 200; // Fixed cost for scenes videos
